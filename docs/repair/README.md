...
For opt-in external model/runtime experiments, see [`external-adapters.md`](external-adapters.md). ClawSweeper remains Codex-first and does not bundle provider-specific adapter runtimes.
